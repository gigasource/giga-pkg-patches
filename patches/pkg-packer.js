...
var _common = require("../../pkg/prelude/common");

var _log = require("../../pkg/lib-es5/log");

var _package = require("../../pkg/package.json");
...
const bootstrapText = _fsExtra.default.readFileSync(require.resolve('../../pkg/prelude/bootstrap.js'), 'utf8').replace('%VERSION%', _package.version);

const commonText = _fsExtra.default.readFileSync(require.resolve('../../pkg/prelude/common.js'), 'utf8');
